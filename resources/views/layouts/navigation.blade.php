            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user() && Auth::user()->roles->pluck('name')->contains('admin'))
                        ...
                        <x-nav-link :href="route('books.borrowApproval')" :active="request()->routeIs('books.borrowApproval')">
                            {{ __('Peminjaman Buku') }}
                        </x-nav-link>
                    ...
                    <x-dropdown-header>
                        ...
                        <x-slot name="content">
                            ...
                            <li>
                                <a href="{{ url('categories/'.$category->id.'/books') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{$category->name}}</a>
                            </li>
                            @endforeach
                        </x-slot>
                ...
                @if (Route::has('login'))
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Register</a>
                            @endif
                        @endauth
                @endif
